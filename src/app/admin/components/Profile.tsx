...
import { Linkedin, GraduationCap, Globe, Mail, Pencil, Trash2 } from "lucide-react";
        ...
        <div className="bg-white rounded-xl shadow-md w-full max-w-5xl overflow-hidden border border-slate-200 flex flex-col lg:flex-row">
          ...
          <div className="flex-1 flex flex-col p-6 sm:p-8">
            <div className="flex justify-between items-center border-b border-slate-100 pb-3 mb-5">
              <h2 className="text-base font-semibold text-slate-700">About</h2>
              <div className="flex gap-2">
                ...
                <button
                  ...
                  aria-label="Delete about content"
                >
            ...
            <div className="text-sm sm:text-base text-slate-600 leading-relaxed space-y-3">
              ...
              {!loading && !error && aboutContent.length === 0 && (
                <p className="text-slate-400 italic">No about content available. Click the edit button to add content.</p>
              )}
            </div>
          </div>
        </div>
