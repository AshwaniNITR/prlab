      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          <div className="flex justify-between items-start mb-4">
            <h2 className="text-2xl font-bold text-blue-900 pr-4">
              {item.title}
            </h2>
            <button
              onClick={onClose}
              ...
              <>
                {(item as Patent).ApplNo && (
                  <div className="flex border-b border-gray-100 py-2">
                    <span className="font-semibold text-blue-800 w-32 flex-shrink-0">
                      Application No:
                    </span>
            ...
            {type === "journal" && (
              <>
                {(item as Journal).authors && (
                  <div className="flex border-b border-gray-100 py-2">
                    <span className="font-semibold text-blue-800 w-20 flex-shrink-0">
                      Authors:
                    </span>
                    <span className="text-gray-700">
                      {(item as Journal).authors}
            ...
            {type === "conference" && (
              <>
                {(item as Conference).authors && (
                  <div className="flex border-b border-gray-100 py-2">
                    <span className="font-semibold text-blue-800 w-24 flex-shrink-0">
                      Authors:
                    </span>
                    <span className="text-gray-700">
                      {(item as Conference).authors}
